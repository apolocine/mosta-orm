...
export type DialectType = 'mongodb' | 'sqlite' | 'sqljs' | 'postgres' | 'pglite' | 'mysql' | 'mariadb' | 'oracle' | 'mssql' | 'cockroachdb' | 'db2' | 'hana' | 'hsqldb' | 'spanner' | 'sybase' | 'duckdb' | 'firestore' | 'firebird' | 'clickhouse';
/**
