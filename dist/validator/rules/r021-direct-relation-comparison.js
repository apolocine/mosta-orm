...
export const R021_DIRECT_RELATION_COMPARISON = {
    id: 'R021-DIRECT-RELATION-COMPARISON',
    description: "Détecte les comparaisons `entity.relation === value` — toujours fausses sous fetch:'eager'.",
        ...
        for (const sf of ctx.sourceFiles) {
            ...
            for (const bin of binaries) {
                ...
                findings.push({
                    ...
                    message: `Comparaison \`${fullText}\` — \`${relationName}\` est une relation ORM ; ` +
 ...
 */
function relationAccess(node, relationNames) {
