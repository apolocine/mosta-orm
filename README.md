...
> **Plug & Play ORM to Drive 16 Databases at Once**
...
[![dialects](https://img.shields.io/badge/dialects-16-success.svg)](#databases)
...
Hibernate-inspired multi-dialect ORM for Node.js & TypeScript — **one API, 16 databases, zero lock-in, bundler-friendly**.
...
- 🎯 **One API, 16 dialects.** Switch from PostgreSQL to MongoDB to Firestore to SQLite without rewriting a single repository call.
...
- 🌉 **Drop-in Prisma replacement.** [`@mostajs/orm-bridge`](https://www.npmjs.com/package/@mostajs/orm-bridge) lets you keep your Prisma code while running on any of 16 databases.
...
|---|:---:|:---:|:---:|:---:|
| SQL dialects | **11** *(PG, MySQL, MariaDB, SQLite, MSSQL, Oracle, DB2, HANA, Cockroach, DuckDB, Firebird…)* | 5 | 5 | 8 |
...
SQLite · PostgreSQL · MySQL · MariaDB · MongoDB · Oracle · SQL Server · CockroachDB · DB2 · SAP HANA · HSQLDB · Spanner · Sybase · DuckDB · Firestore · Firebird
...
npm install better-sqlite3      # or: pg, mysql2, mongoose, oracledb, mssql, ibm_db, mariadb, @sap/hana-client, @google-cloud/spanner, duckdb, node-firebird
...
| Package | Description |
|---|---|
| [@mostajs/orm-bridge](https://www.npmjs.com/package/@mostajs/orm-bridge) | Keep your Prisma code, run it on any of the 16 databases (`createPrismaLikeDb()` is a drop-in replacement for `new PrismaClient()`). |
